...
public class MyMealsActivity extends AppCompatActivity {
    ...
    private String API_URL = "http://airchef-server.herokuapp.com/api/mymeals/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeContainer = (SwipeRefreshLayout) findViewById(R.id.myMealsSwipeContainer);
    ...
    private void setupDrawer() {
        new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        new PrimaryDrawerItem().withName("My Meals").withIdentifier(3).withSelectable(false),
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem != null) {
                            ...
                            if (drawerItem.getIdentifier() == 1) {
                                intent = new Intent(MyMealsActivity.this, myProfileActivity.class);
                            } else if (drawerItem.getIdentifier() == 2) {
                                intent = new Intent(MyMealsActivity.this, ExploreMealsActivity.class);
                            } else if (drawerItem.getIdentifier() == 3) {
//                                intent = new Intent(MyMealsActivity.this, MyMealsActivity.class);
                            } else if (drawerItem.getIdentifier() == 4) {
                                intent = new Intent(MyMealsActivity.this, PurchasedMealsActivity.class);
                            } else if (drawerItem.getIdentifier() == 5) {
                                Stormpath.logout();
                                intent = new Intent(MyMealsActivity.this, StormpathLoginActivity.class);
                            }
                            if (intent != null) {
    ...
    public void onClickViewMeal(View view) {
        Intent intent = new Intent(MyMealsActivity.this, ViewMealActivity.class);
    ...
    private class GetMeals extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            // Set adapter
            ListView mealListing = (ListView) findViewById(R.id.myMealsListView);
            adapter = new MealsAdapter(MyMealsActivity.this, mealsList);
